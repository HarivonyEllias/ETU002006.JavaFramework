...
cp ./myframework.jar ./temp/WEB-INF/lib && 
...
javac -classpath ./myframework.jar -d ./temp/WEB-INF/classes --enable-preview --release 19 $(find ./test-framework/ -name '*.java')
cd ./temp
